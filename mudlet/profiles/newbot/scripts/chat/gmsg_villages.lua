...
function gmsg_villages()
	...
	if chatvars.showHelp then
		if chatvars.words[3] then		
			if chatvars.words[3] ~= "villages" then
				skipHelp = true
			end
		end
	...
	if chatvars.showHelp and not skipHelp and chatvars.words[1] ~= "help" then
		...
		irc_QueueMsg(players[chatvars.ircid].ircAlias, "Village Commands:")	
		irc_QueueMsg(players[chatvars.ircid].ircAlias, "=================")
		irc_QueueMsg(players[chatvars.ircid].ircAlias, "")	
	end

if debug then dbug("debug villages 1") end
...
if debug then dbug("debug villages 2") end
...
if debug then dbug("debug villages 3") end
...
if debug then dbug("debug villages 4") end
...
if debug then dbug("debug villages 5") end
...
if debug then dbug("debug villages 6") end
...
if debug then dbug("debug villages 7") end
...
if debug then dbug("debug villages 8") end
...
if debug then dbug("debug villages 9") end
