...
function gmsg_coppi_old()
	calledFunction = "gmsg_coppi_old"

	if (debug) then dbug("debug coppi_old line " .. debugger.getinfo(1).currentline) end
...
if debug then dbug("debug coppi_old end") end
