...
function refreshScripts()
	...
	if (debug) then dbug("debug refreshScripts line " .. debugger.getinfo(1).currentline) end				
	...
	if benchmarkBot then	
		dbug("function refreshScripts elapsed time: " .. string.format("%.2f", os.clock() - benchStart))
	end		
end
...
function reloadBotScripts(skipTables)
	...
	if (debug) then dbug("debug reloadBotScripts line " .. debugger.getinfo(1).currentline) end			
	...
	if (debug) then dbug("debug reloadBotScripts line " .. debugger.getinfo(1).currentline .. " skip tables\n") end									
	...
	if benchmarkBot then	
		dbug("function reloadBotScripts elapsed time: " .. string.format("%.2f", os.clock() - benchStart))
	end		
end
